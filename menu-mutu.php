<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li
            class="treeview <?php echo ($_GET['view'] == 'identitas' || $_GET['view'] == 'kurikulum') || $_GET['view'] == 'tahunakademik' || $_GET['view'] == 'angkatan' || $_GET['view'] == 'gedung' || $_GET['view'] == 'ruangan' || $_GET['view'] == 'golongan' || $_GET['view'] == 'ptk' || $_GET['view'] == 'jurusan' || $_GET['view'] == 'kelas' || $_GET['view'] == 'statuspegawai' ? 'active' : ''; ?>">
        ...
        <li
            class="treeview <?php echo ($_GET['view'] == 'siswa' || $_GET['view'] == 'guru' || $_GET['view'] == 'wakilkepala' || $_GET['view'] == 'admin') ? 'active' : ''; ?>">
      ...
      <ul class="treeview-menu">
        ...
        <li
            class="treeview <?php echo ($_GET['view'] == 'raportuts' || $_GET['view'] == 'raportcetakuts' || $_GET['view'] == 'capaianhasilbelajar' || $_GET['view'] == 'extrakulikuler' || $_GET['view'] == 'prestasi' || $_GET['view'] == 'raport' || $_GET['view'] == 'raportcetak') ? 'active' : ''; ?>">
        ...
        <li><a href="index.php?view=aktivitaspembelajaran"><i class="glyphicon glyphicon-align-justify"></i>
                <span>Aktivitas Pembelajaran</span></a></li>
        <li><a href="index.php?view=refleksiguru"><i class="fa fa-thumbs-up" aria-hidden="true"></i><span>Hasil
                    Refleksi</span></a></li>
        <li class="<?php echo ($_GET['view'] == 'dokumentasi') ? 'active' : ''; ?>"><a
