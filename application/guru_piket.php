            ...
            <div class='table-responsive'>
                ...
                <table id='example' class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                        ...
                        $no = 1;
                        if (mysql_num_rows($tampil) > 0 && $sudah_disetujui) { // Memeriksa apakah ada data dan sudah disetujui
                            while ($r = mysql_fetch_array($tampil)) {
                                // var_dump($r);
                                echo "<tr><td>$no</td>
                                <td>$r[nip]</td>
                                ...
                                <td>
                                  ...
                                  <a href='index.php?view=absensiguru&act=detail&nip=$r[nip]&bulan=$bulan_dipilih&tanggal=$tanggal_dipilih' class='btn btn-success' title='detail'><i class='fa fa-eye'></i>Agenda mengajar</a>
                                  <a href='' class='btn btn-danger' title='Hapus' onclick='return confirm(\"Apakah Anda yakin ingin menghapus?\")'><i class='fa fa-times'></i></a>
                                </td>";
