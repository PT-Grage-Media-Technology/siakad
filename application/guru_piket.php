...
<?php
    ...
    $tujuan_belajar = mysql_query("SELECT * FROM rb_journal_list a JOIN rb_rekap_absen_guru b ON a.users=b.nip WHERE users='$_GET[nip]' AND DAY(a.tanggal) = '$_GET[tanggal]' AND MONTH(a.tanggal) = '$_GET[bulan]'");
