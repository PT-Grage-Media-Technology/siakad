...
<?php
    ...
    $m = mysql_query("SELECT * FROM rb_rekap_absen_guru a JOIN rb_guru b ON a.nip=b.nip WHERE nip='$_GET[nip]' AND MONTH(tanggal)='$_GET[bulan]' AND DAY(tanggal)='$_GET[tanggal]'");
