<div class="col-xs-12">
  <div class="box">
    ...
    <div class="box-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            if($_SESSION['is_kurikulum']){
              ...
              c.kode_pelajaran, 
              d.nama_guru, 
              ag.kode_kehadiran  -- Mengambil kode kehadiran dari tabel absensi
      ...
      LEFT JOIN rb_absensi_guru ag ON jl.kodejdwl = ag.kodejdwl AND d.nip = ag.nip  -- Menghubungkan dengan tabel absensi
