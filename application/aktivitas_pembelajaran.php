            ...
            if ($_SESSION['is_kurikulum']) {
              ...
              while ($r = mysql_fetch_array($tampil)) {
                echo "<tr>
                        ...
                        $pemberitahuan = mysql_query("SELECT * FROM rb_pemberitahuan_guru WHERE nip='$r[users]', is_read=0, kode_kelas='$r[kode_kelas]', kode_mapel='$r[kode_pelajaran]', id_tujuan_pembelajaran='$r[id_journal]', tanggal_absen='$r[tanggal]', jam_ke='$r[jam_ke]'");
                        var_dump($pemberitahuan);
                        echo"
