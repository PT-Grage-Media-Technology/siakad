        ...
        <div class='panel-body' style='overflow-x: auto; display: block;'>
              <table class='table table-bordered table-striped'>
                              ...
                              while($r=mysql_fetch_array($tampil)){
                                ...
                                $nilaiUH = mysql_fetch_array(mysql_query("SELECT nilai FROM rb_nilai_srl WHERE kodejdwl='$_GET[jdwl]' AND nisn='$r[nisn]'"));
                                ...
                                $nilaiAkhir = round(($bobotHarian / 100) *  $nilaiUH) +0.2*$nilaiSTS['angka_pengetahuan']+0.3*$nilaiSAS['nilai'];
