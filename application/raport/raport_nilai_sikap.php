...
while ($r = mysql_fetch_array($tampil)) {
  ...
  echo "<tr>
                      ...
                      <td align=center><textarea name='a" . $no . "' class='form-control' style='width:100%; color:blue; resize: vertical;' placeholder=' Tuliskan Positif...'>$des[positif]</textarea></td>
                      <td align=center><textarea name='b" . $no . "' class='form-control' style='width:100%; color:blue; resize: vertical;' placeholder=' Tuliskan Negatif...'>$des[negatif]</textarea></td>
                      <td align=center><textarea name='c" . $no . "' class='form-control' style='width:100%; color:blue; resize: vertical;' placeholder=' Tuliskan Deskripsi...'>$des[deskripsi]</textarea></td>
                    </tr>";
...
echo "</tbody>
                    ...
                    <div class='box-footer'>
                      <button type='submit' name='simpan-sikap' class='btn btn-info w-full sm:w-auto'>Simpan</button>
                      <button type='reset' class='btn btn-default pull-right w-full sm:w-auto'>Cancel</button>
                    </div>
                    </form>
                    </div>";
...
while ($r = mysql_fetch_array($tampil)) {
  ...
  while ($n = mysql_fetch_array($pe)) {
    ...
    echo "<tr>
                                    <td></td>
                                    <td></td>
                                    <td align=center style='word-wrap: break-word;'>$n[kd]</td>
                                    <td align=center style='word-wrap: break-word;'>$n[nilai1]</td>
                                    <td align=center style='word-wrap: break-word;'>$n[nilai2]</td>
                                    <td align=center style='word-wrap: break-word;'>$n[nilai3]</td>
                                    <td align=center style='word-wrap: break-word;'>$n[nilai4]</td>
                                    <td align=center style='word-wrap: break-word;'>$n[nilai5]</td>
                                    <td align=center style='word-wrap: break-word;'>" . number_format($ratarata) . "</td>
                                    <td align=center style='word-wrap: break-word;'>$grade1[grade]</td>
                                    <td style='word-wrap: break-word;'>$n[deskripsi]</td>
                                    <td align=center>
                                        <a href='index.php?view=raport&act=listsiswasikap&jdwl=" . $_GET[jdwl] . "&kd=" . $_GET[kd] . "&id=" . $_GET[id] . "&tahun=" . $_GET[tahun] . "&edit_pengetahuan=" . $n[id_nilai_pengetahuan] . "&nisn=" . $r[nisn] . "#$r[nisn]' class='btn btn-xs btn-success'>
                                            <span class='glyphicon glyphicon-edit'></span>
                                        </a>
                                        <a href='index.php?view=raport&act=listsiswasikap&jdwl=" . $_GET[jdwl] . "&kd=" . $_GET[kd] . "&id=" . $_GET[id] . "&tahun=" . $_GET[tahun] . "&delete_pengetahuan=" . $n[id_nilai_pengetahuan] . "&nisn=" . $r[nisn] . "' class='btn btn-xs btn-danger' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\">
  ...
  echo "<tr>
                                      <td></td><td></td>
                                      <td align=center colspan='6' style='word-wrap: break-word;'>Nilai Max/Min</td>
                                      <td align=center style='word-wrap: break-word;'>" . number_format($maxn[rata_rata]) . "</td>
                                      <td align=center style='word-wrap: break-word;'>$grade2[grade]</td><td></td>
                                    </tr>
                                    <tr>
                                      <td></td><td></td>
                                      <td align=center colspan='6' style='word-wrap: break-word;'>Raport</td>
                                      <td align=center style='word-wrap: break-word;'>" . number_format($rapn[raport]) . "</td>
                                      <td align=center style='word-wrap: break-word;'>$grade3[grade]</td><td style='word-wrap: break-word;'>$maxn[deskripsi]</td>
                                    </tr>";
...
while ($r = mysql_fetch_array($tampil)) {
  ...
  if ($_GET[nisn] == $r[nisn]) {
    ...
    echo "<form action='index.php?view=raport&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]' method='POST'>
                                      <tr>
                                        ...
                                        <input type='hidden' name='id' value='$e[id_nilai_pengetahuan]'>
                                        <input type='hidden' name='status' value='$name'>
                                        <td align=center><input type='text' name='a' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' name='b' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' name='c' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' name='d' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' name='e' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' name='f' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' name='g' style='width:35px; text-align:center; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='text' style='width:35px; background:#e3e3e3; border:1px solid #e3e3e3; max-width:100%;' disabled></td>
                                        <td align=center><input type='text' style='width:35px; background:#e3e3e3; border:1px solid #e3e3e3; max-width:100%;' disabled></td>
                                        <td align=center><input type='text' name='h' style='width:100%; padding:0px; max-width:100%;'></td>
                                        <td align=center><input type='submit' name='simpan-keterampilan' class='btn btn-xs btn-primary' style='width:65px' value='$name'></td>
                                      </tr>
                                      </form>";
  ...
  while ($n = mysql_fetch_array($pe)) {
    ...
    echo "<tr>
                                      ...
                                      <td>$n[deskripsi]</td>
                                      <td align=center>
                                          <a href='index.php?view=raport&act=listsiswasikap&jdwl=" . $_GET[jdwl] . "&kd=" . $_GET[kd] . "&id=" . $_GET[id] . "&tahun=" . $_GET[tahun] . "&edit_keterampilan=" . $n[id_nilai_keterampilan] . "&nisn=" . $r[nisn] . "#$r[nisn]' class='btn btn-xs btn-success' style='max-width: 100%;'><span class='glyphicon glyphicon-edit'></span></a>
                                          <a href='index.php?view=raport&act=listsiswasikap&jdwl=" . $_GET[jdwl] . "&kd=" . $_GET[kd] . "&id=" . $_GET[id] . "&tahun=" . $_GET[tahun] . "&delete_keterampilan=" . $n[id_nilai_keterampilan] . "&nisn=" . $r[nisn] . "' class='btn btn-xs btn-danger' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\" style='max-width: 100%;'><span class='glyphicon glyphicon-remove'></span></a>
                                      </td>
                                    </tr>";
  ...
  echo "<tr>
                                      <td></td><td></td>
                                      <td align=center colspan='7' style='word-wrap: break-word; word-break: break-all;'>Nilai Max/Min</td>
                                      <td align=center style='word-wrap: break-word; word-break: break-all;'>" . number_format($maxn[tertinggi]) . "</td>
                                      <td align=center style='word-wrap: break-word; word-break: break-all;'>$grade2[grade]</td><td></td>
                                    </tr>
                                    <tr>
                                      <td></td><td></td>
                                      <td align=center colspan='7' style='word-wrap: break-word; word-break: break-all;'>Raport</td>
                                      <td align=center style='word-wrap: break-word; word-break: break-all;'>" . number_format($rapn[raport]) . "</td>
                                      <td align=center style='word-wrap: break-word; word-break: break-all;'>$grade3[grade]</td><td style='word-wrap: break-word; word-break: break-all;'>$maxn[deskripsi]</td>
                                    </tr>";
