...
echo "<div role='tabpanel' class='tab-pane fade' id='keterampilan' aria-labelledby='keterampilan-tab'>
          ...
          <div class='panel-body'>
              <div class='table-responsive'> <!-- Menambahkan pembungkus responsif -->
              <table class='table table-bordered table-striped'>
                                <tr>
                                  <th style='border:1px solid #e3e3e3' width='30px' rowspan='2'>No</th>
                                  <th style='border:1px solid #e3e3e3' width='170px' rowspan='2'>Nama Lengkap</th>
...
while ($r = mysql_fetch_array($tampil)) {
  ...
  if ($_GET[nisn] == $r[nisn]) {
    ...
    echo "<form action='index.php?view=raport&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]' method='POST'>
                                      <tr>
                                        ...
                                        <input type='hidden' name='id' value='$e[id_nilai_pengetahuan]'>
                                        <input type='hidden' name='status' value='$name'>
                                        <td align=center><input type='text' name='a' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' name='b' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' name='c' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' name='d' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' name='e' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' name='f' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' name='g' style='max-width:35px; text-align:center; padding:0px'></td>
                                        <td align=center><input type='text' style='max-width:35px; background:#e3e3e3; border:1px solid #e3e3e3;' disabled></td>
                                        <td align=center><input type='text' style='max-width:35px; background:#e3e3e3; border:1px solid #e3e3e3;' disabled></td>
  ...
  while ($n = mysql_fetch_array($pe)) {
    ...
    echo "<tr>
                                      <td></td>
                                      <td></td>
                                      <td align=center style='max-width: 50px;'>$n[kd]</td>
                                      <td align=center style='max-width: 50px;'>$n[nilai1]</td>
                                      <td align=center style='max-width: 50px;'>$n[nilai2]</td>
                                      <td align=center style='max-width: 50px;'>$n[nilai3]</td>
                                      <td align=center style='max-width: 50px;'>$n[nilai4]</td>
                                      <td align=center style='max-width: 50px;'>$n[nilai5]</td>
                                      <td align=center style='max-width: 50px;'>$n[nilai6]</td>
                                      <td align=center style='max-width: 50px;'>" . number_format($ratarata) . "</td>
                                      <td align=center style='max-width: 50px;'>$grade1[grade]</td>
                                      <td style='max-width: 150px;'>$n[deskripsi]</td>
                                      <td align=center>
  ...
  echo "<tr>
                                              <td></td><td></td>
                                              <td align=center colspan='7' style='max-width: 150px;'>Nilai Max/Min</td>
                                              <td align=center style='max-width: 50px;'>" . number_format($maxn[tertinggi]) . "</td>
                                              <td align=center style='max-width: 50px;'>$grade2[grade]</td><td></td>
                                            </tr>
                                            <tr>
                                              <td></td><td></td>
                                              <td align=center colspan='7' style='max-width: 150px;'>Raport</td>
                                              <td align=center style='max-width: 50px;'>" . number_format($rapn[raport]) . "</td>
                                              <td align=center style='max-width: 50px;'>$grade3[grade]</td><td style='max-width: 150px;'>$maxn[deskripsi]</td>
                                            </tr>";
  $no++;
}
