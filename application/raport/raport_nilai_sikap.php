        ...
        <div class='box-body'>
          ...
          <div class='panel-body'>
                    <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                      ...
                      <li role='presentation' class=''><a href='#pengetahuan' role='tab' id='pengetahuan-tab' data-toggle='tab' aria-controls='sosial' aria-expanded='false'>Penilaian Pengetahuan</a></li>
                    </ul><br>
