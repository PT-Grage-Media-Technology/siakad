    ...
    <div class='box-body'>
      ...
      <div class='panel-body'>
        ...
        <div id='myTabContent' class='tab-content'>";
            ...
            // Halaman Nilai pengetahuam (baru)
          ...
          <div class='panel-body'>
            ...
            echo "<div role='tabpanel' class='tab-pane fade' id='keterampilan' aria-labelledby='keterampilan-tab'>
                  <div class='col-md-12'>
                        <form action='index.php?view=raport&act=listsiswaketerampilan&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]' method='POST'>
                        ...
                        <table class='table table-bordered table-striped'>
                            <tr>
                              ...
                              <th style='border:1px solid #e3e3e3'>Penilaian Keterampilan</th>
                            </tr>
                          <tbody>";
                          $no = 1;
                          $tampil = mysql_query("SELECT * FROM rb_siswa where kode_kelas='$_GET[id]' ORDER BY id_siswa");
                          while($r = mysql_fetch_array($tampil)){
                            echo "<tr>
                                  ...
                                  <td>$r[nisn]</td>
                                  <td>$r[nama]</td>
                                  <td><textarea name='keterampilan".$no."' class='form-control' style='width:100%; color:blue' placeholder='Tuliskan Nilai Keterampilan...'></textarea></td>
                                </tr>";
                            $no++;
                          }
                          echo "</tbody>
