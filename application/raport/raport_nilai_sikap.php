        ...
        <div class='box-body'>
          ...
          <div class='panel-body'>
                    <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                      ...
                      <li role='presentation' class=''><a href='#pengetahuan' role='tab' id='pengetahuan-tab' data-toggle='tab' aria-controls='pengetahuan' aria-expanded='false'>Penilaian Sosial</a></li>
                    </ul><br>
                      ...
                      echo "<div class='col-md-12'>
                            ...
                            <table class='table table-bordered table-striped'>
                                <tr>
                                  <th style='border:1px solid #e3e3e3' width='30px' rowspan='2'>No</th>
                                  <th style='border:1px solid #e3e3e3' width='80px' rowspan='2'>NISN</th>
                                  <th style='border:1px solid #e3e3e3' width='190px' rowspan='2'>Nama Lengkap123</th>
                                  <th style='border:1px solid #e3e3e3' colspan='3'><center>Penilaian Spiritual</center></th>
                                </tr>
                                <tr>
                                  <th style='border:1px solid #e3e3e3;'><center>Positif</center></th>
