    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">
          ...
          if (empty($_GET['kelas'])) {
            $data_kelas = mysql_fetch_array(mysql_query("SELECT * FROM rb_kelas ORDER BY kode_kelas ASC"));
            $kelas = $data_kelas['kode_kelas'];  // Ambil ID tahun terakhir
          } else {
