            ...
            <div class='col-md-12'>
                <div class='table-responsive'>
                    <table class='table table-condensed table-hover'>
                     ...
                     <a class='btn btn-success btn-xs' title='List Bahan dan Tugas' href='index.php?view=bahantugas&act=listbahantugas&jdwl=$j[kodejdwl]&kd=$_GET[kd]&id=$d[kode_kelas]'><span class='glyphicon glyphicon-th'></span> List Bahan dan Tugas</a>
