            ...
            <div class='col-md-12'>
                <div class='table-responsive'>
                    ...
                    <div class='d-flex flex-column align-items-center'>
                      ...
                      <a class='btn btn-success btn-sm mb-2' title='Rekap SRL' href='index.php?view=rekapsrl&act=detailtopic&jdwl=$j[kodejdwl]&idtopic=$idtopic[id_forum_topic]&id_jawaban=$jawaban_refleksi[id_pertanyaan_penilaian]&id_journal=$_GET[id_journal]'>
                    <div class='d-flex flex-column align-items-center'>
                      <div class='glyphicon glyphicon-tasks' style='font-size:28px; margin-right:5px;'></div>
