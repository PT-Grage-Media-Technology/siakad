  ...
  echo "<div class='col-md-12'>
              ...
              <table class='table table-condensed table-hover'>
                  <tbody>
                    ...
                    <tr><th scope='row'><a class='btn btn-success btn-sm' title='Bahan dan Tugas' href='https://siakad.demogmt.online/index.php?view=bahantugas&act=listbahantugas&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$r[kode_pelajaran]'><span class='glyphicon glyphicon-tasks'>Tugas</span></a></th></tr>
                  </tbody>
              </table>
              </div>
