...
<div class='col-md-12'>
  ...
  if (isset($_POST['simpann'])) {
    ...
    for ($i = 1; $i <= $jml_data; $i++) {
        // Cek apakah absensi untuk tanggal tersebut sudah ada
        ...
        if ($total >= 1) {
            // Update absensi siswa jika sudah ada data absensi pada tanggal tersebut
            ...
            if ($updateAbsensiSiswa) {
                ...
                echo "Gagal mengupdate absensi siswa: " . mysql_error();
            }
        } else {
            // Jika absensi belum ada, insert data baru
        ...
        // Jika siswa tidak hadir, kirim notifikasi ke orang tua
        if ($a[$i] != 'H') {
    ...
    // Setelah proses selesai, redirect dan tampilkan data terakhir
    echo "<script>
        document.location = 'index.php?view=absensiswa&act=tampilabsen&id=" . $_POST['kelas'] . "&kd=" . $_POST['pelajaran'] . "&idjr=" . $_POST['jdwl'] . "&tgl=" . $_GET['tgl'] . "&jam=" . $_GET['jam'] . "';
