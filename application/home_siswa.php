<?php if ($_GET[act]==''){ ?>
  ...
  <div class="box">
    <div class="box-header">
      ...
      <form class="d-flex justify-content-end" action="" method="GET" style="margin-top: 5px;">
        <select name="tahun" class="form-select form-select-sm" style="max-width: 150px; margin-right: 5px;">
          <?php 
            ...
            <?php
              if (isset($_GET['tahun'])) {
                $tampil = mysql_query("SELECT a.*, e.nama_kelas, b.namamatapelajaran, b.kode_pelajaran, c.nama_guru, d.nama_ruangan 
                  ...
                  WHERE a.kode_kelas = '$_SESSION[kode_kelas]' AND a.id_tahun_akademik = '$_GET[tahun]'");
