                          ...
                          <tr><td></td>
                              ...
                              <td>
                                <select class='form-control' name='jawab".$no."'>
                                  ...
                                  <option value'$jwb[jawaban]'>Penjelasan Nya Baik Dan Mudah Di Pahami</option>
                                  <option value='$jwb[jawaban]'>Penjelasan Nya Kurang Baik Dan Kurang Dapat Di Pahami</option>
                                  <option value='$jwb[jawaban]'>Tidak Dapat Memahami Apa Yang Dijelaskan</option>
                                </select>
                              </td>
                          </tr>";
                      $no++;
