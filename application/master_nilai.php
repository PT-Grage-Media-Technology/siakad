  ...
  <div class="box">
    ...
    <div class="box-body">
      <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
        ...
        <?php 
         // Query untuk mengambil data dengan nilai 100 secara spesifik
    $nilaiA = mysql_query("SELECT * FROM rb_kriteria_nilai WHERE id = 2");
    $A = mysql_fetch_array($nilaiA);

    echo"<p>
            <input type='text' placeholder='Nilai Huruf' style='width: 40px;' value='{$A['kode_nilai']}'> = <input type='text' style='width: 50px;' value='" . ($A['nilai_angka']) . "'> - <input type='text' style='width: 50px;' value='" . ($kriteriaNilai['nilai_angka'] - 1) . "'>";
