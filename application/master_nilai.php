<div class="col-xs-12">
  <div class="box">
    ...
    $nilaiA = mysql_query("SELECT * FROM rb_kriteria_nilai WHERE id = 1");
    $A = mysql_fetch_array($nilaiA);

    echo"<p>
            <input type='text' placeholder='Nilai Huruf' style='width: 40px;' value='{$A['kode_nilai']}'> = <input type='text' style='width: 50px;' value='" . ('100') . "'> - <input type='text' style='width: 50px;' value='" . (100 - 10) . "'>";
