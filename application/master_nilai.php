  ...
  <div class="box">
    ...
    <div class="box-body">
      <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
        ...
        echo"<p>
            <input type='text' placeholder='Nilai Huruf' style='width: 40px;' value='{$kriteriaNilai['kode_nilai']}'> = <input type='text' style='width: 50px;' value='" . ($kriteriaNilai['nilai_atas']) . "'> - <input type='text' style='width: 50px;' value='" . ($kriteriaNilai['nilai_bawah'] - 1) . "'>";
    }
        ?>
