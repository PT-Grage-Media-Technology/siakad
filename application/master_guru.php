                    ...
                    <div class='table-responsive'>
                      <table class='table table-condensed table-bordered'>
                        <tbody>
                          <input type='hidden' name='id' value='$s[nip]'>
                          <tr>
                            <th colspan='2' style='background-color:#E7EAEC'>
                              <?php if (trim($s[foto]) == ''): ?>
                    ...
                    <div class='table-responsive'>
                      <table class='table table-condensed table-bordered'>
                        <tbody>
                          ...
                          <tr><th scope='row'>TMT Pengangkat</th> <td><?php echo $s[tmt_pengangkatan]; ?></td></tr>
                          <tr><th scope='row'>Lemb. Pengangkat</th> <td><?php echo $s[lembaga_pengangkatan]; ?></td></tr>
                          <tr><th scope='row'>Golongan</th> <td><?php echo $s[nama_golongan]; ?></td></tr>
                          <tr><th scope='row'>Sumber Gaji</th> <td><?php echo $s[sumber_gaji]; ?></td></tr>
                          <tr><th scope='row'>Ahli Laboratorium</th> <td><?php echo $s[keahlian_laboratorium]; ?></td></tr>
                          <tr><th scope='row'>Nama Ibu Kandung</th> <td><?php echo $s[nama_ibu_kandung]; ?></td></tr>
                          <tr><th scope='row'>Nama Suami/Istri</th> <td><?php echo $s[nama_suami_istri]; ?></td></tr>
                          <tr><th scope='row'>Nip Suami/Istri</th> <td><?php echo $s[nip_suami_istri]; ?></td></tr>
                          <tr><th scope='row'>Pekerjaan Suami/Istri</th> <td><?php echo $s[pekerjaan_suami_istri]; ?></td></tr>
                          <tr><th scope='row'>TMT PNS</th> <td><?php echo $s[tmt_pns]; ?></td></tr>
                          <tr><th scope='row'>Lisensi Kepsek</th> <td><?php echo $s[lisensi_kepsek]; ?></td></tr>
                          <tr><th scope='row'>Jml Sekolah Binaan</th> <td><?php echo $s[jumlah_sekolah_binaan]; ?></td></tr>
                          <tr><th scope='row'>Diklat Kepengawasan</th> <td><?php echo $s[diklat_kepengawasan]; ?></td></tr>
                          <tr><th scope='row'>Mampu Handle KK</th> <td><?php echo $s[mampu_handle_kk]; ?></td></tr>
                          <tr><th scope='row'>Keahlian Breile</th> <td><?php echo $s[keahlian_breile]; ?></td></tr>
                          <tr><th scope='row'>Keahlian B.Isyarat</th> <td><?php echo $s[keahlian_bahasa_isyarat]; ?></td></tr>
                          <tr><th scope='row'>Kewarganegaraan</th> <td><?php echo $s[kewarganegaraan]; ?></td></tr>
                          <tr><th scope='row'>NIY NIGK</th> <td><?php echo $s[niy_nigk]; ?></td></tr>
                          <tr><th scope='row'>NPWP</th> <td><?php echo $s[npwp]; ?></td></tr>
                          <tr><th scope='row'>Nama Wajib Pajak</th> <td><?php echo $s[nama_wajib_pajak]; ?></td></tr>
                          <tr><th scope='row'>Kewajiban Belajar 9 Thn</th> <td><?php echo $s[kewajiban_belajar_9_tahun]; ?></td></tr>
                        </tbody>
                      </table>
                    </div>
                  </div>
