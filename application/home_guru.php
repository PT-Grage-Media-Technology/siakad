  ...
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">
        ...
        // Ambil nama tahun berdasarkan tahun yang dipilih
        if (isset($_GET['tahun'])) {
            $nama_tahun_query = mysql_query("SELECT nama_tahun FROM rb_tahun_akademik WHERE id_tahun_akademik = '$tahun_dipilih'");
            $nama_tahun = mysql_fetch_array($nama_tahun_query)['nama_tahun'];
        } else {
            $nama_tahun = $latest_year['nama_tahun'];
        }
