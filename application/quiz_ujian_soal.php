  ...
  while ($r = mysql_fetch_array($tampil)) {
    ...
    if ($_SESSION[level] == 'kepala') {
      ...
      echo "<td><a class='btn btn-primary btn-xs' title='Lihat Soal' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$r[id_quiz_ujian]&id=$_GET[kode_kelas]&kd=$_GET[kd]'><span class='glyphicon glyphicon-search'></span> Lihat Soal</a>
                                          ...
                                          <a class='btn btn-danger btn-xs' title='Delete Bahan dan Tugas' href='index.php?view=soal&act=listsoal&jdwl=$_GET[jdwl]&id=$_GET[kode_kelas]&kd=$_GET[kd]&hapus=$r[id_quiz_ujian]'><span class='glyphicon glyphicon-remove'></span></a></td>";
    }
    echo "</tr>";
    $no++;
  }
        ...
        <div class='modal-dialog' role='document'>
            <div class='modal-content'>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <textarea rows='3' name='a' id='soal_$noo' class='form-control'
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <input style='width:50%' type='text' id='jawab_a_$noo' name='b' value='$ko[jawab_a]' class='form-control' id='jawab_a'>
                </div>
              </div>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <input style='width:50%' type='text' id='jawab_b_$noo' name='c' value='$ko[jawab_b]' class='form-control' id='jawab_b'>
                </div>
              </div>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <input style='width:50%' type='text'  id='jawab_c_$noo' name='d' value='$ko[jawab_c]' class='form-control' id='jawab_c'>
                </div>
              </div>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <input style='width:50%' type='text' id='jawab_d_$noo' name='e' value='$ko[jawab_d]' class='form-control' id='jawab_d'>
                </div>
              </div>
              ...
              <div class='form-group'>
                ...
                <div class='col-sm-10'>
                  <input style='width:50%' type='text' name='f' id='jawab_e_$noo' value='$ko[jawab_e]' class='form-control' id='jawab_e'>
                </div>
              </div>
...
echo "      </div>
  ...
  while ($r = mysql_fetch_array($tampil)) {
    ...
    if ($sekarangwaktu > $bataswaktu3) {
      ...
      echo "<td><a style='width:100px' class='btn btn-primary btn-xs' title='Lihat Soal' href='index.php?view=soal&act=jawabsemuasoal&jdwl=$_GET[jdwl]&idsoal=$r[id_quiz_ujian]&id=$_GET[kode_kelas]&kd=$_GET[kd]'><span class='glyphicon glyphicon-search'></span> Jawab Soal</a></td>";
    }
    echo "</tr>";
    $no++;
  }
