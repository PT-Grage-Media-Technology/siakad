    ...
    <td>
        <div style='display: flex; align-items: center;'>
            ...
            <a 
                ...
                title='Simpan Nilai' 
                href='index.php?view=soal&act=semuajawabansiswa&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&kode_kelas=$_GET[kode_kelas]&kd=$_GET[kd]&noinduk=$_GET[noinduk]&simpannilai' 
