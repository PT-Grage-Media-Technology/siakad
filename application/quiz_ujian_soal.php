...
elseif ($_GET[act] == 'semuasoal') {
  ...
  while ($ko = mysql_fetch_array($objektif)) {
    ...
    echo "<div class='btn btn-default btn-xs btn-block'>Kunci Jawaban : $ko[kunci_jawaban]</div>
                            ...
                            <a href='' class='btn btn-primary btn-sm pull-right btn-xs' data-toggle='modal' data-target='#objektif-edit' data-id = data-id='" . htmlspecialchars($objektif['id_pertanyaan_objektif']) . "'><span class='glyphicon glyphicon-remove'></span></a></td>
