...
elseif ($_GET[act] == 'semuasoal') {
  ...
  while ($ko = mysql_fetch_array($objektif)) {
    ...
    echo "<div class='btn btn-default btn-xs btn-block'>Kunci Jawaban : $ko[kunci_jawaban]</div>
                            ...
                            <td style='width:60px'><a class='btn btn-success btn-xs' href='index.php?view=soal&act=semuasoal&jdwl=$_GET[jdwl]&idsoal=$_GET[idsoal]&id=$_GET[kode_kelas]&kd=$_GET[kd]'><span class='glyphicon glyphicon-remove'></span></a></td>
                            </tr>";
    $noo++;
  }
  echo "</table>
