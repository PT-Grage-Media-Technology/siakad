...
?>
  ...
  <div class="box">
    <form action='' method='POST'>
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped table-responsive" style="width: 100%; overflow-x: auto;">
          <thead>
            <tr>
...
<!-- Responsif Mobile dengan Bootstrap classes -->
<div class="col-xs-12">
  <div class="box">
    <form action='' method='POST'>
      <div class="box-header">
        ...
        <?php 
          ...
          echo "<tr><td>$no</td>
                ...
                <tr><td></td>
                        ...
                        <input type='hidden' value='$r[id_pertanyaan_penilaian]' name='id".$no."'>
                        <input type='hidden' value='$_GET[nisn]' name='nisn".$no."'>
                    <td><textarea class='form-control' name='jawab".$no."' placeholder='Tulis Jawaban disini...'>$jwb[jawaban]</textarea></td>
                </tr>";
            $no++;
            }
        ?>
