<?php if ($_GET[act] == '') { ?>
  ...
  echo "</div>
                <div class='box-body'>
                  ...
                  <a class='btn btn-success btn-sm mb-2' title='Bahan dan Tugas' href='https://siakad.demogmt.online/index.php?view=raportuts&act=listsiswa&jdwl=$_GET[id]&kd=$d[kode_pelajaran]&id=X.MIPA.1&tahun=$_GET[tahun]'>
