  ...
  while ($r = mysql_fetch_array($tampil)) {
    ...
    if ($_SESSION['level'] != 'kepala') {
      echo "<td style='width:80px !important'><center>
                ...
                <a class='btn btn-danger btn-xs' title='Delete Data' href='index.php?view=journalguru&hapus=$r[id_journal]&jdwl=$_GET[id]'><span class='glyphicon glyphicon-remove'>sas</span></a>
              </center></td>";
    }
    echo "</tr>";
    $no++;
