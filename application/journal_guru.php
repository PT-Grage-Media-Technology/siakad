...
<?php if ($_GET[act] == '') { ?>
  ...
  <div class='table-responsive'>
    <table class='table table-condensed table-hover'>
      <tbody>
        <tr><th width='80px' scope='row'>Nama Kelas</th> <td>$d[nama_kelas]</td></tr>
    ...
    <div style=\'max-width: 360px; margin: 20px auto; padding: 10px;\'>
  <!-- Grid container untuk 4 kolom -->
  <div style=\'display: grid; grid-template-columns: repeat(4, 80px); gap: 10px; justify-content: center;\'>
    <!-- Tombol Nilai UTS -->
    <a class=\'btn btn-success\' style=\'height: 80px; padding: 10px; display: flex; align-items: center; justify-content: center;\'
