  ...
  while ($r = mysql_fetch_array($tampil)) {
    ...
    if ($_SESSION[level] != 'kepala') {
      echo "<td style='width:80px !important'><center>
                                        <a class='btn btn-success btn-xs' title='Edit Data' href='index.php?view=absensiswa&act=tampilabsen&id=X.MIPA.1&kd=$d[namamatapelajaran]'><span class='glyphicon glyphicon-edit'>Absen</span></a>
