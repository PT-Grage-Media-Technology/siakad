    ...
    if ($r['id_parent_journal'] == NULL || $r['id_parent_journal'] == '') {
        ...
        if ($_SESSION['level'] != 'kepala') {
            ...
            echo "<td style='width: 200px; !important'><center>
                    <a class='btn btn-success btn-xs' title='Absen' href='$absenLink' $buttonDisabled onclick='this.onclick=null; this.classList.add(\"disabled\");'><span class='glyphicon glyphicon-edit'>Absen11</span></a>
        ...
        while ($sub = mysql_fetch_array($tampilSub)) {
            ...
            if ($_SESSION['level'] != 'kepala') {
              ...
              // $absenLinkSub = ($sub['tanggal'] > $today) ? '#' : "index.php?view=absensiswa&act=tampilabsen&id=$d[kode_kelas]&kd=$d[kode_pelajaran]&idjr=$_GET[id]&tgl={$sub['tanggal']}&jam={$sub['jam_ke']}&id_journal={$sub['id_journal']}";
                ...
                echo "<td style='width: 200px; !important'><center>
                        <a class='btn btn-success btn-xs' title='Absen' href='index.php?view=absensiswa&act=tampilabsen&id=$d[kode_kelas]&kd=$d[kode_pelajaran]&idjr=$_GET[id]&tgl={$sub['tanggal']}&jam={$sub['jam_ke']}&id_journal={$sub['id_journal']}'><span class='glyphicon glyphicon-edit'>Absen22</span></a>
