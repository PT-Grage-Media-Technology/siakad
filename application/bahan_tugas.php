...
if ($_GET[act] == '') {
    ...
    <div class="box">
      <div class="box-header d-flex justify-content-between align-items-center">
        ...
        <form class='d-flex align-items-center' action='' method='GET'>
          ...
          <select name='kelas' class='form-select me-2'>
            <option value=''>- Pilih Kelas -</option>
            <?php
            $kelas = mysql_query("SELECT * FROM rb_kelas");
            while ($k = mysql_fetch_array($kelas)) {
              echo "<option value='$k[kode_kelas]' " . ($_GET['kelas'] == $k['kode_kelas'] ? 'selected' : '') . ">$k[kode_kelas] - $k[nama_kelas]</option>";
            }
            ?>
          </select>
            ...
            while ($r = mysql_fetch_array($tampil)) {
              ...
              echo "<tr>
                            ...
                            <td style='width:70px'><center>
                                <a class='btn btn-success btn-xs' title='List Bahan dan Tugas' href='index.php?view=bahantugas&act=listbahantugas&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]'>
                                    <span class='glyphicon glyphicon-th'></span> List Bahan dan Tugas
                                </a>
                            </center></td>
                        </tr>";
              $no++;
              ...
              <div class='table-responsive'>
                  <table class='table table-condensed table-hover'>
                      <tbody>
                          ...
                          <tr><th scope='row'>Kode Kelas</th> <td>$d[kode_kelas]</td></tr>
  ...
  while ($r = mysql_fetch_array($tampil)) {
    ...
    if ($_SESSION['level'] == 'superuser') {
      ...
      if ($r[id_kategori_elearning] == '1') {
        echo "<a style='margin-right:5px' class='btn btn-info btn-xs' title='Download Bahan dan Tugas' href='download.php?file=$r[file_upload]'><span class='glyphicon glyphicon-download'></span> Download</a>";
      } else {
        echo "<a style='margin-right:5px' class='btn btn-success btn-xs' title='Jawaban Bahan dan Tugas' href='index.php?view=bahantugas&act=kirimjawaban&jdwl=$_GET[jdwl]&id=$_GET[id]&kd=$_GET[kd]&ide=$r[id_elearning]'><span class='glyphicon glyphicon-upload'></span> Jawaban</a>";
      }
      ...
      echo "<a style='margin-left:3px' class='btn btn-warning btn-xs' title='Edit $r[nama_kategori_elearning]' href='index.php?view=bahantugas&act=edit&jdwl=" . $_GET['jdwl'] . "&id=" . $_GET['id'] . "&kd=" . $_GET['kd'] . "&edit=$r[id_elearning]'><span class='glyphicon glyphicon-edit'></span></a>
                <a class='btn btn-danger btn-xs' title='Delete $r[nama_kategori_elearning]' href='index.php?view=bahantugas&act=listbahantugas&jdwl=" . $_GET['jdwl'] . "&id=" . $_GET['id'] . "&kd=" . $_GET['kd'] . "&hapus=$r[id_elearning]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a></td>";
    }
    echo "</tr>";
    $no++;
  }
  ...
  //                                 <input type='file' class='files' name='c' onchange='$('#upload-file-info').html($(this).val());' style='display:none;'>
  //                               </a> 
  ...
  <div class='table-responsive'>
    <table class='table table-condensed table-bordered'>
      <tbody>
        ...
        <tr>
          <th scope='row'>Waktu Mulai</th>      
          <td><input type='text' class='form-control' value="<?php echo date("Y-m-d H:i:s"); ?>" name='d'></td>
        </tr>
        
        <!-- Waktu Selesai -->
        <tr>
          <th scope='row'>Waktu Selesai</th>    
          <td><input type='text' class='form-control' value="<?php echo date("Y-m-d H:i:s"); ?>" name='e'></td>
        </tr>
  ...
  $kategori = mysql_query("SELECT * FROM rb_kategori_elearning");
  while ($a = mysql_fetch_array($kategori)) {
    $selected = ($s['id_kategori_elearning'] == $a['id_kategori_elearning']) ? 'selected' : '';
  ...
  echo "</select>
                                  ...
                                  <tr>
                                    <th scope='row'>Nama File</th>
                                    <td><input type='text' class='form-control' name='b' value='$s[nama_file]'></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <th scope='row'>Waktu Selesai</th>
                                    <td><input type='text' class='form-control' value='$s[tanggal_selesai]' name='e'></td>
                                  </tr>
                                  <tr>
                                    <th scope='row'>Keterangan</th>
                                    <td><input type='text' class='form-control' name='f' value='$s[keterangan]'></td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
  ...
  <div class="col-12">
    <div class="box">
      <div class="box-header">
        ...
        <form style='margin-right:5px; margin-top:0px' class='float-end' action='' method='GET'>
          <input type="hidden" name='view' value='bahantugas'>
          <input type="hidden" name='act' value='listbahantugasguru'>
          <select name='tahun' class='form-select' style='padding:4px;'>
            <?php
    ...
    <div class="box">
      <div class="box-header d-flex justify-content-between align-items-center">
        ...
        <form class='d-flex' action='' method='GET'>
          ...
          <select name='tahun' class='form-select me-2' style='padding:4px'>
            <?php
            echo "<option value=''>- Pilih Tahun Akademik -</option>";
            $tahun = mysql_query("SELECT * FROM rb_tahun_akademik");
            while ($k = mysql_fetch_array($tahun)) {
                  ...
                  <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                    <div class='col-md-12'>
                      <table class='table table-condensed table-bordered'>
                        <tbody>
                          <tr>
                            <th width='120px' scope='row'>Nama File</th>
                            <td>
                              <div style='position:relative;'>
                                <a class='btn btn-primary' href='javascript:;'>
                          ...
                          <tr>
                            <th scope='row'>Keterangan</th>
                            <td><textarea rows='5' class='form-control' name='a'></textarea></td>
                          </tr>
                        </tbody>
                      </table>
  ...
  while ($r = mysql_fetch_array($tampil)) {
    echo "<tr>
            ...
            <td>$r[waktu] WIB</td>
            <td>
              <a class='btn btn-info btn-xs' title='Download Bahan dan Tugas' href='download.php?file=$r[file_tugas]'>
                <span class='glyphicon glyphicon-download'></span> Download
              </a>
            </td>
          </tr>";
