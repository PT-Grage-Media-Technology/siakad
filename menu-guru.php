...
// var_dump($tahun);
    ...
    $tahun = mysql_fetch_array(mysql_query("SELECT * FROM rb_tahun_akademik ORDER BY id_tahun_akademik DESC"));
      echo "<li class='treeview'>
        ...
        <li><a href='index.php?view=capaianhasilbelajar&tahun=$tahun[id_tahun_akademik]&id=$tampil[kode_kelas]'><i class='fa fa-circle-o'></i> Data Capaian Belajar</a></li>
        ...
        <li><a href='index.php?view=raportcetak&tahun=$tahun[id_tahun_akademik]&kelas=$tampil[kode_kelas]'><i class='fa fa-circle-o'></i> Cetak Raport</a></li>
        </ul>
      </li>";
    } else {
    }
