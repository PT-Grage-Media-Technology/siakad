    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <?php
          if ($_GET['view'] == 'home' || $_GET['view'] == '') {
            // Cek level user
            if ($_SESSION['level'] == 'guru') {
              // Redirect ke halaman detail guru jika levelnya adalah 'guru'
              header("Location: index.php?view=guru&act=detailguru&id=195806161984000002");
