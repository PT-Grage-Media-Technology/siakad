...
if (isset($_SESSION['id'])) {
  ...
  if ($_SESSION['level'] == 'superuser') {
    ...
    $penjamin_mutu = mysql_fetch_array(mysql_query("SELECT * FROM rb_guru WHERE nip='$_SESSION[id]' AND id_jenis_ptk=$id_mutu[id_jenis_ptk]"));
    if ($penjamin_mutu) {
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          if ($_GET[view] == 'home' or $_GET[view] == '') {
            ...
            if ($_SESSION['level'] === 'superuser' || $_SESSION['level'] === 'kepala' || $_SESSION['is_kurikulum'] == 'true' || $_SESSION['is_penjamin_mutu'] == 'true') {
              echo "<div class='row'>";
    ...
    <div class="modal fade" id="essai" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method='POST'
            action='index.php?view=soal&act=semuasoal&jdwl=<?php echo $_GET[jdwl]; ?>&idsoal=<?php echo $_GET[idsoal]; ?>&kode_kelas=<?php echo $_GET[kode_kelas]; ?>&kd=<?php echo $_GET[kd]; ?>'
            class="form-horizontal">
            <div class="modal-body">
    ...
    <div class="modal fade" id="objektif" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method='POST'
            action='index.php?view=soal&act=semuasoal&jdwl=<?php echo $_GET[jdwl]; ?>&idsoal=<?php echo $_GET[idsoal]; ?>&kode_kelas=<?php echo $_GET[id]; ?>&kd=<?php echo $_GET[kd]; ?>'
            class="form-horizontal">
            <div class="modal-body">
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-2 control-label">Soal</label>
